...
from vision.mediapipe_handler_demo import MediapipeHandler
from vision.drawing import draw_landmarks_on_image
from gestures.gesture_logic_demo import detect_pos_flex
...
async def main():
    ...
    while True:
        ...
        if ((mediapipe_handler.hors_champ) and (now - last_send > 0.1)):
            ...
            if (data != None):
                parser.update(data)
                detect_pos_flex(parser.flex)
                print("Gyro : ", parser.gyro)
